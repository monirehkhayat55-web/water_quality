...
The following steps summarize the time series modeling procedure applied to the phosphate concentration data.
...
A simple linear regression model was estimated to evaluate the baseline behavior of the phosphate series.
Result:
...
### 4. Differencing
First-order differencing was applied to achieve stationarity.
Result:
- ADF statistic = −9.48
- p-value ≈ 0
...
- Durbin-Watson
### 7. ARCH Effect Test
ARCH test on residuals indicated conditional heteroskedasticity.
Conclusion:
...
Confidence intervals were derived from the logistic distribution:
95% CI
99% CI
Values outside these intervals were flagged as anomalies
